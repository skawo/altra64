...
LINK_FLAGS = -L$(ROOTDIR)/lib -L$(ROOTDIR)/toolchain/gcc-toolchain-mips64/mips64-elf/lib -L$(ROOTDIR)/toolchain/libdragon/lib -lm -lc -lg -ldragon -lnosys -ldragonsys -lmikmod -lmad -lyaml -Tn64ld.x
